          ...
          <div className="reveal grid-2" style={{ transitionDelay: '.1s' }}>
            {[
              ...
              <div key={i} className="card card-accent">
                ...
                <p style={{ fontSize: '.87rem', color: 'var(--n500)', lineHeight: 1.6 }}>{b.desc}</p>
              </div>
            ))}
          </div>
            ...
            <div className="pricing-box">
              <div className="pricing-inner">
                ...
                <div className="guarantee" style={{ marginTop: 20 }}>
                  ...
                  <p style={{ fontWeight: 700, fontSize: '.9rem', color: 'var(--g800)', marginBottom: 5 }}>Your Purchase Is Safe & Permanent</p>
                  <p style={{ fontSize: '.83rem', color: 'var(--n600)', lineHeight: 1.6 }}>One payment, lifetime access. Your Blueprint and all bonuses are delivered instantly to your email — yours to keep forever.</p>
                </div>
              </div>
            </div>
          </div>
