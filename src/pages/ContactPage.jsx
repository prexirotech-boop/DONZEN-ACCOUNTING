...
export default function ContactPage() {
  ...
  const contactChannels = [
    ...
    },
    {
      ...
      label: 'Email Us',
      value: 'donzenconsulting@gmail.com',
      href: 'mailto:donzenconsulting@gmail.com',
      color: '#ff1717'
    },
    {
        ...
        <section className="cp-bottom-cta" ref={ctaRef}>
          <div className={`cp-bottom-cta-inner ${ctaVis ? 'cp-vis' : ''}`}>
            ...
            <div className="cp-bottom-cta-btns">
              <a href="https://wa.me/message/XUEP2CGZ4FM6E1" target="_blank" rel="noopener noreferrer" className="cp-cta-btn cp-cta-btn-primary">
                Chat on WhatsApp
