...
export default function AdminDashboard() {
  ...
  const [expandedTabs, setExpandedTabs] = useState(() => {
    ...
    if (location.pathname.includes('/courses') || location.pathname.includes('/qna') || location.pathname.includes('/reviews') || location.pathname.includes('/certificates')) active.Academics = true
